...
export const PagesData: {[key: string]: TPagesData} = {
  'dehumidification': {
    ...
    achivments: ['Индивидуальный подход к каждому объекту', 'Использование профессионального оборудования и инструментов', 'Возможность создания индивидуальных планов уборки под ваши нужды', 'Гарантия безопасности для сотрудников и посетителей'],
  ...
  'dismantling': {
    ...
    achivments: ['Опытная команда специалистов с многолетним стажем', 'Индивидуальный подход к каждому объекту', 'Использование современного оборудования и инструментов', 'Гарантия безопасности при работе', 'Быстрое выполнение работ с минимальным воздействием на окружающую среду'],
